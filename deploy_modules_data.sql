-- DNA Ops Manual - Modules Data Deployment
-- Execute this SQL in the Supabase Dashboard SQL Editor
-- Project: ocgqvncgcbbdnpsuxona
-- Date: 2026-05-23
-- ==============================================

-- Step 1: Add depends_on column (if not already added)
-- This column stores array of module codes that this module depends on
...
-- Step 2: Insert all 10 modules with dependencies
-- Uses ON CONFLICT to upsert (insert or update if exists)
...
SELECT code, name, category, is_active, depends_on FROM modules ORDER BY sort_order;
