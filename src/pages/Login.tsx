...
export default function Login() {
  ...
  const { signIn, completeTwoFactorLogin, isAuthenticated, isLoading: authLoading, authState, pendingUserId } = useAuth();
  ...
  // Show 2FA modal if already in pending verification state
  useEffect(() => {
    if (authState === 'password_verified_pending_2fa_verification' && pendingUserId) {
      console.log('🔓 Auto-showing 2FA modal, pendingUserId:', pendingUserId);
